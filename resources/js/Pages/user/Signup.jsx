    ...
    return (
        ...
        <Navbar/>
            <div className="flex flex-col md:flex-row h-screen items-center font-nunito ">
                <div
                    className="bg-white w-full lg:max-w-full md:mx-12 md:p-20 md:w-full xl:w-2/5 h-screen px-6 lg:px-16 xl:px-12
          flex items-center justify-center shadow-lg"
                >
                    <div className="w-full h-100">
                        ...
                        <h1 className="text-xl md:text-2xl font-bold leading-tight mt-2 text-center">
                            SIGN UP
                        </h1>
                        <form onSubmit={handleSubmit} className="mt-6">
                            <div>
                                <label className="block text-gray-700 md:text-xl lg:text-base">
                                    Email Address
                                </label>
                                <input
                                    type="email"
                                    ...
                                    className={`w-full px-4 py-3 rounded-lg bg-white mt-2 border ${
                                        emailError
                                            ? "border-red-500"
                                            : "border-gray-300"
                            ...
                            <button
                                type="submit"
                                className="w-full block bg-yellow-500 hover:bg-amber-400 focus:bg-amber-400 text-white font-semibold rounded-lg px-4 py-3 mt-6"
                            >
                                Sign In
                            </button>
                        </form>
                        <p className="mt-8 md:text-xl lg:text-lg">
                            Already have an account?{" "}
                            <a
                                href="/login"
                                className="text-blue-500 hover:text-blue-700 font-semibold md:text-xl lg:text-lg"
                            >
